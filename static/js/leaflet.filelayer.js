...
L.Control.FileLayerLoad = L.Control.extend({
    statics: {
        TITLE: 'Subir al mapa archivos (Soporta: KML, GeoJSON y GPX)',
        LABEL: '<div align="center" ><i class="fa fa-upload fa-2x"></i></div>'
    },
    options: {
        position: 'topleft',
        fitBounds: true,
    ...
    _initContainer: function () {
        ...
        L.DomEvent.on(link, 'click', function (e) {
            alert("Otra forma de subir tus capas es arrastrando el archivo desde la carpeta local a la zona del mapa. Recuerda que deben de estar en coordenadas geografícas WGS-84 o Web Mercator");
            fileInput.click();
            e.preventDefault();
        });
        return container;
